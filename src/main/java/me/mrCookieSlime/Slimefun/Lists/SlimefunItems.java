...
public final class SlimefunItems {
	...
	public static final ItemStack ANIMAL_GROWTH_ACCELERATOR = new CustomItem(Material.HAY_BLOCK, "&bУскоритель роста животных", "", "&rРаботает на &aорганической пище", "", MachineTier.END_GAME.and(MachineType.MACHINE), "&8\u21E8 &e\u26A1 &7Резервный запас: &71024 Дж", "&8\u21E8 &e\u26A1 &728 Дж/с");
	public static final ItemStack CROP_GROWTH_ACCELERATOR = new CustomItem(Material.LIME_TERRACOTTA, "&aУскоритель роста растений", "", "&rРаботает на &aорганических удобрениях", "", MachineTier.END_GAME.and(MachineType.MACHINE), "&8\u21E8 &7Радиус: 7x7", "&8\u21E8 &7Скорость: &a3/(время роста)", "&8\u21E8 &e\u26A1 &7Резервный запас: &71024 Дж", "&8\u21E8 &e\u26A1 &750 Дж/с");
	public static final ItemStack CROP_GROWTH_ACCELERATOR_2 = new CustomItem(Material.LIME_TERRACOTTA, "&aУскоритель роста растений &7(&eII&7)", "", "&rРаботает на &aорганических удобрениях", "", MachineTier.END_GAME.and(MachineType.MACHINE), "&8\u21E8 &7Радиус: 9x9", "&8\u21E8 &7Скорость: &a4/(время роста)", "&8\u21E8 &e\u26A1 &7Резервный запас: &71024 Дж", "&8\u21E8 &e\u26A1 &760 Дж/с");

	public static final ItemStack FOOD_FABRICATOR = new CustomItem(Material.GREEN_STAINED_GLASS, "&cПищевая фабрика", "", "&rПроизводит &aорганическую пищу", "", MachineTier.ADVANCED.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 1x", "&8\u21E8 &e\u26A1 &7Резервный запас: &7256 Дж", "&8\u21E8 &e\u26A1 &714 Дж/с");
	public static final ItemStack FOOD_FABRICATOR_2 = new CustomItem(Material.GREEN_STAINED_GLASS, "&cПищевая фабрика &7(&eII&7)", "", "&rПроизводит &aорганическую пищу", "", MachineTier.END_GAME.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 6x", "&8\u21E8 &e\u26A1 &7Резервный запас: &7512 Дж", "&8\u21E8 &e\u26A1 &748 Дж/с");
	
	public static final ItemStack FOOD_COMPOSTER = new CustomItem(Material.GREEN_TERRACOTTA, "&cПищевой компостер", "", "&rПроизводит &aорганические удобрения", "", MachineTier.ADVANCED.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 1x", "&8\u21E8 &e\u26A1 &7Резервный запас: &7256 Дж", "&8\u21E8 &e\u26A1 &716 Дж/с");
	public static final ItemStack FOOD_COMPOSTER_2 = new CustomItem(Material.GREEN_TERRACOTTA, "&cПищевой компостер &7(&eII&7)", "", "&rПроизводит &aорганические удобрения", "", MachineTier.END_GAME.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 10x", "&8\u21E8 &e\u26A1 &7Резервный запас: &7512 Дж", "&8\u21E8 &e\u26A1 &752 Дж/с");
	...
	public static final ItemStack REACTOR_COOLANT_CELL = new CustomItem(getSkull("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvZGU0MDczYmU0MGNiM2RlYjMxMGEwYmU5NTliNGNhYzY4ZTgyNTM3MjcyOGZhZmI2YzI5NzNlNGU3YzMzIn19fQ=="), "&bЯчейка охлаждающей жидкости");
	...
	public static final ItemStack REACTOR_ACCESS_PORT = new CustomItem(Material.CYAN_TERRACOTTA, "&2Порт доступа к реактору", "", "&rПозволяет взаимодействовать с реактором", "&rпри помощи грузовых узлов, а также", "&rможет быть использован в качестве", "&rрезервного запаса", "", "&8\u21E8 &eДолжен быть помещён &a3 блоками &eвыше реактора");
	
	public static final ItemStack FREEZER = new CustomItem(Material.LIGHT_BLUE_STAINED_GLASS, "&bМорозилка", "", MachineTier.ADVANCED.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 1x", "&8\u21E8 &e\u26A1 &7Резервный запас: &7256 Дж", "&8\u21E8 &e\u26A1 &718 Дж/с");
	public static final ItemStack FREEZER_2 = new CustomItem(Material.LIGHT_BLUE_STAINED_GLASS, "&bМорозилка &7(&eII&7)", "", MachineTier.END_GAME.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 2x", "&8\u21E8 &e\u26A1 &7Резервный запас: &7256 Дж", "&8\u21E8 &e\u26A1 &730 Дж/с");
	
	public static final ItemStack ELECTRIC_GOLD_PAN = new CustomItem(Material.BROWN_TERRACOTTA, "&6Электрическая рудопромывочная машина", "", MachineTier.BASIC.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 1x", "&8\u21E8 &e\u26A1 &72 Дж/с");
	public static final ItemStack ELECTRIC_GOLD_PAN_2 = new CustomItem(Material.BROWN_TERRACOTTA, "&6Электрическая рудопромывочная машина &7(&eII&7)", "", MachineTier.BASIC.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 3x", "&8\u21E8 &e\u26A1 &74 Дж/с");
	public static final ItemStack ELECTRIC_GOLD_PAN_3 = new CustomItem(Material.BROWN_TERRACOTTA, "&6Электрическая рудопромывочная машина &7(&eIII&7)", "", MachineTier.END_GAME.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 10x", "&8\u21E8 &e\u26A1 &714 Дж/с");

	public static final ItemStack ELECTRIC_DUST_WASHER = new CustomItem(Material.BLUE_STAINED_GLASS, "&3Электрический очиститель пыли", "", MachineTier.BASIC.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 1x", "&8\u21E8 &e\u26A1 &76 Дж/с");
	public static final ItemStack ELECTRIC_DUST_WASHER_2 = new CustomItem(Material.BLUE_STAINED_GLASS, "&3Электрический очиститель пыли &7(&eII&7)", "", MachineTier.BASIC.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 2x", "&8\u21E8 &e\u26A1 &710 Дж/с");
	public static final ItemStack ELECTRIC_DUST_WASHER_3 = new CustomItem(Material.BLUE_STAINED_GLASS, "&3Электрический очиститель пыли &7(&eIII&7)", "", MachineTier.END_GAME.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 10x", "&8\u21E8 &e\u26A1 &730 Дж/с");

	public static final ItemStack ELECTRIC_INGOT_FACTORY = new CustomItem(Material.RED_TERRACOTTA, "&cЭлектрический завод слитков", "", MachineTier.BASIC.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 1x", "&8\u21E8 &e\u26A1 &78 Дж/с");
	public static final ItemStack ELECTRIC_INGOT_FACTORY_2 = new CustomItem(Material.RED_TERRACOTTA, "&cЭлектрический завод слитков &7(&eII&7)", "", MachineTier.BASIC.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 2x", "&8\u21E8 &e\u26A1 &714 Дж/с");
	public static final ItemStack ELECTRIC_INGOT_FACTORY_3 = new CustomItem(Material.RED_TERRACOTTA, "&cЭлектрический завод слитков &7(&eIII&7)", "", MachineTier.END_GAME.and(MachineType.MACHINE), "&8\u21E8 &7Скорость: 8x", "&8\u21E8 &e\u26A1 &740 Дж/с");

	public static final ItemStack AUTOMATED_CRAFTING_CHAMBER = new CustomItem(Material.CRAFTING_TABLE, "&6Автоматизированная камера крафта", "", MachineTier.ADVANCED.and(MachineType.MACHINE), "&8\u21E8 &e\u26A1 &710 Дж/предмет");
	public static final ItemStack FLUID_PUMP = new CustomItem(Material.BLUE_TERRACOTTA, "&9Жидкостный насос", "", MachineTier.ADVANCED.and(MachineType.MACHINE), "&8\u21E8 &e\u26A1 &732 Дж/блок");
	public static final ItemStack CHARGING_BENCH = new CustomItem(Material.CRAFTING_TABLE, "&6Зарядное устройство-верстак", "", "&rЗаряжает предметы (например, реактивный ранец)", "", MachineTier.BASIC.and(MachineType.MACHINE), "&8\u21E8 &e\u26A1 &7Резервный запас: &7128 Дж", "&8\u21E8 &e\u26A1 &7Потери электричества: &c50%");

	public static final ItemStack WITHER_ASSEMBLER = new CustomItem(Material.OBSIDIAN, "&5Иссушающий ассемблер", "", MachineTier.END_GAME.and(MachineType.MACHINE), "&8\u21E8 &7Задержка: &b30 секунд", "&8\u21E8 &e\u26A1 &7Резервный запас: &74096 Дж", "&8\u21E8 &e\u26A1 &74096 Дж/Визер");
	
	public static final ItemStack TRASH_CAN = new CustomItem(getSkull("eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvMzJkNDEwNDJjZTk5MTQ3Y2MzOGNhYzllNDY3NDE1NzZlN2VlNzkxMjgzZTZmYWM4ZDMyOTJjYWUyOTM1ZjFmIn19fQ=="), "&3Мусорное ведро", "", "&rУничтожает все вещи, помещённые в него");
	
	public static final ItemStack ELYTRA = new CustomItem(Material.ELYTRA, "&rЭлитры");
	public static final ItemStack ELYTRA_SCALE = new CustomItem(Material.FEATHER, "&bЧешуя элитр");
	public static final ItemStack INFUSED_ELYTRA = new CustomItem(ELYTRA, "&5Заряженные элитры");
	public static final ItemStack SOULBOUND_ELYTRA = new CustomItem(ELYTRA, "&cПерсональные элитры", "&7&oНе выпадают при смерти");
