...
public class GitHubService {
	...
	public void connect(boolean logging) {
		...
		connectors.add(new ContributionsConnector(this, "code", repository, "&6Разработчик"));
		connectors.add(new ContributionsConnector(this, "wiki", "TheBusyBiscuit/Slimefun4-wiki", "&3Редактор Вики"));
		connectors.add(new ContributionsConnector(this, "resourcepack", "TheBusyBiscuit/Slimefun4-Resourcepack", "&cТекстурщик"));
