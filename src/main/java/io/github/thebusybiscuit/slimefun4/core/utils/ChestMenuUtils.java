...
public final class ChestMenuUtils {
	...
	private static final ItemStack BACK_BUTTON = new SlimefunItemStack("_UI_BACK", Material.ENCHANTED_BOOK, "&7\u21E6 Назад", meta -> meta.addItemFlags(ItemFlag.HIDE_ENCHANTS));
	private static final ItemStack MENU_BUTTON = new SlimefunItemStack("_UI_MENU", Material.COMPARATOR, "&eНастройки / Информация", "", "&7\u21E8 Нажмите, чтобы увидеть больше");
